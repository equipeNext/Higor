...
function displayProductionSummary() {
    ...
    for (let i = 0; i < productions.length; i++) {
        ...
        productionListItem.textContent = "Data: " + production.dia + "/" + production.mes + "/" + production.ano + " - Hora: " + production.hora + ":" + production.minuto + ":" + production.segundo + " - Quantidade: " + production.quantidade + " tijolos";
